 ...
 */
@Controller
@Api(tags = "PmsProductCategoryController:商品分类管理")
...
public class ProductCategoryController {
    ...
    @ResponseBody
    public CommonResult create(@Validated @RequestBody PProductCategory productCategory) {
    ...
    public CommonResult update(@PathVariable Long id,
                               @Validated
                               @RequestBody PProductCategory productCategory) {
    ...
    @ResponseBody
    public CommonResult<CommonPage<PProductCategory>> getList(@PathVariable Long parentId,
                                                                @RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize,
                                                                @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        List<PProductCategory> productCategoryList = productCategoryService.getList(parentId, pageSize, pageNum);
    ...
    @ResponseBody
    public CommonResult<PProductCategory> getItem(@PathVariable Long id) {
        PProductCategory productCategory = productCategoryService.getItem(id);
