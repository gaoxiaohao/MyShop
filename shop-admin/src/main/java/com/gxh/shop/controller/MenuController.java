...
public class MenuController {
    ...
    @ResponseBody
    public CommonResult create(@RequestBody SMenu menu) {
    ...
    @ResponseBody
    public CommonResult<SMenu> getItem(@PathVariable Long id) {
        SMenu umsMenu = menuService.getItem(id);
    ...
    @ResponseBody
    public CommonResult<CommonPage<SMenu>> list(@PathVariable Long parentId,
                                                  @RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize,
                                                  @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        List<SMenu> menuList = menuService.list(parentId, pageSize, pageNum);
