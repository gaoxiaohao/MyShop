...
public class CartItemController {
    ...
    @ResponseBody
    public CommonResult add(@RequestBody OCartItem cartItem) {
    ...
    @ResponseBody
    public CommonResult<List<OCartItem>> list() {
        List<OCartItem> cartItemList = cartItemService.list(memberService.getCurrentMember().getId());
    ...
    @ResponseBody
    public CommonResult updateAttr(@RequestBody OCartItem cartItem) {
