...
@Controller
@Slf4j
@Api(tags = "PortalOrderController")
...
public class PortalOrderController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<OrderDetails>> list(@RequestParam Integer status,
                                                       @RequestParam(required = false, defaultValue = "1") Integer pageNum,
                                                       @RequestParam(required = false, defaultValue = "5") Integer pageSize) {
        CommonPage<OrderDetails> orderPage = portalOrderService.list(status,pageNum,pageSize);
    ...
    @ResponseBody
    public CommonResult<OrderDetails> detail(@PathVariable Long orderId) {
        OrderDetails orderDetail = portalOrderService.detail(orderId);
